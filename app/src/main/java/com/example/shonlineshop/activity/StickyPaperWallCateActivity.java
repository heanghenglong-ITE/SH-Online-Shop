...
public class StickyPaperWallCateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sticky_paper_wall_cate);
    ...
    private void makeApiRequest(String category) {
        ...
        call.enqueue(new Callback<List<ActivityDomain>>() {
            ...
            public void onResponse(@NonNull Call<List<ActivityDomain>> call, @NonNull Response<List<ActivityDomain>> response) {
                if (response.isSuccessful()) {
                    ...
                    if (activityDomain != null && !activityDomain.isEmpty()) {
                        ...
                        Toast.makeText(StickyPaperWallCateActivity.this, "Error: Empty response", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Log.e("APIResponse", "Error: " + response.message());
                    Toast.makeText(StickyPaperWallCateActivity.this, "Error: " + response.message(), Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(@NonNull Call<List<ActivityDomain>> call, @NonNull Throwable t) {
                ...
                Toast.makeText(StickyPaperWallCateActivity.this, "Network error: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
