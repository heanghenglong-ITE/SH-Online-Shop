...
public class Product1Adapter extends RecyclerView.Adapter<Product1Adapter.ViewHolder> {
    ...
    public Product1Adapter(Context context, List<ActivityDomain> activityDomains) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.viewholder_product1_cate, parent, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ImageView imageCate;
        TextView textDiscount, textName, TextPrice;
